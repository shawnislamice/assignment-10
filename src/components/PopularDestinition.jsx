        ...
        <div>
          <div className="flex lg:flex-row flex-col-reverse justify-between items-center md:my-5 md:gap-5">
            <p className="lg:w-1/2 md:max-w-2xl text-justify py-5 lg:py-0">
              ...
              greenery, and serene beauty. Stretching along the southeastern
              coastline of Bangladesh, Cox's Bazar boasts the world's longest
              natural sandy sea beach. With its golden sands stretching as far
              as the eye can see, bordered by the turquoise waters of the Bay of
              Bengal, Cox's Bazar is a paradise for beach lovers. Visitors can
              enjoy activities like swimming, sunbathing, and beachside picnics
